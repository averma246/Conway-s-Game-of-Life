...
// =============================================================================
     ...
     * @param gridType The kind of grid to create.
     * @param interfaceType The kind of interface to create.
     **/
    public Game (String initialStatePath, String cellType, String gridType, String interfaceType) {

	// Read the initial state, creating a grid of cells as specified.
	readInitialState(initialStatePath, cellType, gridType);

	// Create the user interface.
	if(interfaceType.equals("Dumb")){
	    _userInterface = new DumbTextUserInterface(this);
	}
	
	/*safe to use just "else" here because the only strings accepted 
	  for interfaceType are Dumb and Smart */
	else{
	    _userInterface = new SmartTextUserInterface(this);
	}
     ...
     * @param gridType The kind of grid to populate.
     **/
    private void readInitialState (String initialStatePath, String cellType, String gridType) {
	...
	_grid = Grid.create(rows,columns, cellType,gridType);
